( function( $ ) {
	...
	wp.customize( 'u3a_modern_contact_info_location', function( value ) {
	...
	wp.customize( 'u3a_modern_contact_info_address', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'u3a_modern_contact_info_phone', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'u3a_modern_contact_info_email', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'u3a_modern_contact_info_hours', function( value ) {
		value.bind( function( to ) {
